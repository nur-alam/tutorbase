...
<div id="tutorowl_comments" class="tutorowl-comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			<?php
			$tutorowl_comment_count = get_comments_number();
			if ( '1' === $tutorowl_comment_count ) {
				printf(
					/* translators: 1: title. */
					esc_html__( 'One thought on &ldquo;%1$s&rdquo;', 'tutorowl' ),
		...
		if ( ! comments_open() ) :
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'tutorowl' ); ?></p>
			<?php
		endif;
