...
class Helpers {
	...
	public static function get_template_list() {
		// $template_response       = wp_remote_get( TUTOROWL_TEMPLATE_LIST_ENDPOINT );
		$template_response = file_get_contents( TUTOROWL_TEMPLATE_LIST_ENDPOINT );
		...
		try {
			// $template_response = wp_remote_post( TUTOROWL_TEMPLATE_LIST_ENDPOINT );
